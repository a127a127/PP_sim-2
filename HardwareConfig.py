...
class HardwareConfig(object):
    def __init__(self):
        ...
        self.Power_shift_and_add_in_CU = 0.2 / 1000
        ...
        self.Energy_shift_and_add_in_PE = self.Power_shift_and_add_in_PE / self.PE_frequency / self.shift_and_add_num_in_PE # per data
